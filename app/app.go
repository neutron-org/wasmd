...
func NewWasmApp(
	...
	// TODO(pr0n00gler): see the deleted code in the diff; I think we should remove this controller code
	// completely in production. I'm not sure I did that correctly here.
